...
<div class="container">
		...
		<%for(int i=0;i<usuarios.size();i++){
			...
			%>
				<tr class="line<%=ind%>">
					...
					<td><a href="/User/Read?idUsuario=<%=usuario.getId()%>">View</a></td>
					<td><a href="/User/Create?mode=update&idUsuario=<%=usuario.getId()%>">Update</a></td>
					<td><a href="/User/Delete?idUsuario=<%=usuario.getId()%>">Delete</a></td>
				</tr>
			<% 
		}
		%>
		...
		<br>
		<a href="/User/Create?mode=create">Crear  nuevo Usuario</a>
	</div>
</body>
</html>