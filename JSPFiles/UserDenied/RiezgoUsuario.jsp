...
<header id="header" >
	...
	<p>Existen Usuarios con este rol, de continuar con la acción Estos serían eliminados<a href="/UsersDelete?id=<%=id%>">Continuar</a>
	<br>En caso de existir Accesos para este rol, también serán eliminados</p>
